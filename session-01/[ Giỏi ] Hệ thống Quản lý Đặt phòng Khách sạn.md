...
| ------------------------------ | ----------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------- |
| Khách sạn (Hotel)              | PK: Mã khách sạn<br />Tên<br />Địa chỉ<br />Số sao<br />Mô tả<br />Người quản lý<br />FK: Mã phòng<br />FK: Mã Đánh giá | 1 -> N Phòng<br />1 -> N Đánh giá                              |
...
| Đánh giá (Review)              | PK: Mã đánh giá<br />Điểm số<br />Bình luận<br />Ngày đăng<br />FK: Mã khách hàng                                       | N -> 1 Khách sạn<br />N -> 1 Khách hàng                        |
| Phòng_Đặt Phòng (Room_Booking) | PK: Mã phòng<br />PK: Mã đặt phòng                                                                                      | Phòng N <-> N Đặt phòng<br />( Bảng trung gian )               |

### Phân tích

> Giữa Phòng ( Room ) và Đặt phòng ( Booking ) là mối quan hệ N:N
>
> - Vì Một Phòng có thể xuất hiện trong Đặt phòng theo từng khung giờ khác nhau
> - Vì Đặt Phòng có thể gồm nhiều phòng theo từng khung giờ khác nhau
>
> Nếu mối quan hệ nhiều nhiều phải sử dụng bảng trung gian và có 2 khoá chính `PRIMARY KEY(Mã phòng, Mã Đặt phòng)`
